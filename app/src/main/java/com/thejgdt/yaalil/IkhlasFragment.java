...
public class IkhlasFragment extends Fragment {

    private static final String ARG_PARAM1 = "param1";
    private static final String ARG_PARAM2 = "param2";

    public IkhlasFragment() {
        // Required empty public constructor
    }

    public static IkhlasFragment newInstance(String param1, String param2) {
        IkhlasFragment fragment = new IkhlasFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_ikhlas, container, false);

        ScrollView ikhlasView = rootView.findViewById(R.id.mainView);

        try {
            InputStream inputStream = getResources().openRawResource(R.raw.ikhlas);
            ...
            ikhlasView.addView(linearLayout);
        } catch (Exception e) {
            e.printStackTrace();
        }

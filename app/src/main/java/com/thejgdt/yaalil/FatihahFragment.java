...
public class FatihahFragment extends Fragment {

    private static final String ARG_PARAM1 = "param1";
    private static final String ARG_PARAM2 = "param2";

    public FatihahFragment() {
        // Required empty public constructor
    }

    public static FatihahFragment newInstance(String param1, String param2) {
        FatihahFragment fragment = new FatihahFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_fatihah, container, false);

        ScrollView fatihahView = rootView.findViewById(R.id.mainView);

        try {
            InputStream inputStream = getResources().openRawResource(R.raw.fatihah);
            ...
            fatihahView.addView(linearLayout);
        } catch (Exception e) {
            e.printStackTrace();
        }

...
public class BaqarahFragment extends Fragment {

    private static final String ARG_PARAM1 = "param1";
    private static final String ARG_PARAM2 = "param2";

    public BaqarahFragment() {
        // Required empty public constructor
    }

    public static BaqarahFragment newInstance(String param1, String param2) {
        BaqarahFragment fragment = new BaqarahFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_baqarah, container, false);

        ScrollView BaqarahView = rootView.findViewById(R.id.mainView);

        try {
            InputStream inputStream = getResources().openRawResource(R.raw.baqarah);
            ...
            BaqarahView.addView(linearLayout);
        } catch (Exception e) {
            e.printStackTrace();
        }

...
public class FalaqFragment extends Fragment {

    private static final String ARG_PARAM1 = "param1";
    private static final String ARG_PARAM2 = "param2";

    public FalaqFragment() {
        // Required empty public constructor
    }

    public static FalaqFragment newInstance(String param1, String param2) {
        FalaqFragment fragment = new FalaqFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_falaq, container, false);

        ScrollView falaqView = rootView.findViewById(R.id.mainView);

        try {
            InputStream inputStream = getResources().openRawResource(R.raw.falaq);
            ...
            falaqView.addView(linearLayout);
        } catch (Exception e) {
            e.printStackTrace();
        }
